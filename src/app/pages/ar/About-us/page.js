    ...
    <main dir="rtl" className="w-full font-sans text-neutral-800 bg-white">
      ...
      <ScrollReveal delay={100} className="relative z-10 flex flex-col w-full bg-[#fbe1ac] -mt-4 xs:-mt-1 sm:-mt-4 md:-mt-1 lg:-mt-2 xxlg:-mt-4 xxxlg:-mt-4 mb-10 sm:mb-16 px-4 sm:px-6 md:px-8 py-10 xs:py-2 sm:py-2.5 md:py-3 lg:py-4 text-center">
        ...
        <p className="max-w-4xl mx-auto text-[#1a4b8c] font-bold text-sm sm:text-base md:text-lg leading-relaxed sm:leading-loose drop-shadow-sm">
          حققت شركة عصر طلائي برتر إسبادانا، المالكة للعلامتين التجاريتين جلفا ومازستا، إنجازات قيمة في صناعة الأغذية بالاعتماد على الجودة والابتكار والخبرة. في عام 2024، حصلت الشركة على شهادة الالتزام بالجودة من المنظمة الوطنية الإيرانية للمعايير، كما حصلت على لقب أفضل وحدة إنتاج في صناعة الأغذية في محافظة أصفهان. بالإضافة إلى ذلك، فإن الحصول على لقب أفضل مدير فني في صناعة الأغذية في محافظة أصفهان، والذي يدل على قدرة وكفاءة الإدارة الفنية للشركة، هو أحد إنجازاتها الأخرى. استمراراً لمسار الابتكار، في عام 2025، رسخت الشركة مكانتها في تطوير المنتجات الغذائية القائمة على المعرفة من خلال تسجيل براءة اختراع صلصة الجبن المطبوخ.
        </p>
