    ...
    <main dir="rtl" className="flex min-h-screen flex-col font-sans bg-white">
      ...
      <ScrollReveal delay={100} className="relative z-10 flex flex-col w-full bg-[#fbe1ac] -mt-8 xs:-mt-1 sm:-mt-4 md:-mt-6 lg:-mt-10 xxlg:-mt-12 xxxlg:-mt-20 mb-10 sm:mb-16 px-4 sm:px-6 md:px-8 py-10 xs:py-2 sm:py-2.5 md:py-3 lg:py-4 text-center">
        ...
        <p className="max-w-4xl mx-auto text-[#1a4b8c] font-bold text-sm sm:text-base md:text-lg leading-relaxed sm:leading-loose drop-shadow-sm">
          نحن نقدم لكم مجموعة متنوعة من المنتجات الطازجة والأصلية، لنصنع لكم
          تجربة مختلفة من الطعم والجودة. يتم إنتاج جميع منتجاتنا باستخدام أفضل
          المواد الأولية ووفقاً لمعايير صارمة، حيث تظل سلامتكم ورضاكم دائماً في
          أولوياتنا. نضمن لكم من خلال الرقابة الدقيقة على الجودة في جميع مراحل
          الإنتاج أن تحظى كل عبوة جبن بنفس الطعم الذي تتوقعونه. باختياركم
          لمنتجاتنا، أنتم تضيفون مزيجاً من الصحة والجودة والتنوع إلى مائدتكم.
        </p>
