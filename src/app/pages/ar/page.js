  ...
  return (
    ...
    px-2 sm:px-6 md:px-10 lg:px-16 xl:px-20"
      ...
      >
        {/* جبنة */}
        <Link
          href="/pages/ar/products?category=cheese"
        ...
        {/* صلصة */}
        <Link
          href="/pages/ar/products?category=sauce"
          className="flex flex-col items-center justify-center gap-1 sm:gap-2 lg:gap-3 transition-transform hover:scale-105"
        >
          <Image
        ...
        {/* زبدة */}
        <Link
          href="/pages/ar/products?category=butter"
          className="flex flex-col items-center justify-center gap-1 sm:gap-2 lg:gap-3 transition-transform hover:scale-105"
        >
          <Image
        ...
        {/* قشطة (خامه) */}
        <Link
          href="/pages/ar/products?category=cream"
          className="flex flex-col items-center justify-center gap-1 sm:gap-2 lg:gap-3 transition-transform hover:scale-105"
        >
          <Image
      ...
      >
        ...
        <p className="max-w-4xl mx-auto text-[#1a4b8c] font-bold md:text-lg leading-relaxed drop-shadow-sm">
          جلفا تعني مزيجاً من الجودة والصحة والنكهات الأصيلة. من خلال إنتاج أفضل
          أنواع الجبن والزبدة والقشطة والصلصات من مواد خام طازجة تماماً، خلقنا
          معايير جديدة في صناعة الأغذية. مع منتجات جلفا، اشعر بالفرق في النضارة
          والجودة في كل قضمة.
        </p>
      </div>
