        ...
        <div className="p-6 md:p-8">
          <div className="flex flex-col md:flex-row-reverse md:items-start gap-6">
            ...
            <aside className="md:w-1/3">
              <h2 className="text-lg font-semibold mb-3">المكونات</h2>
              <ul className="space-y-2">
                ...
                {(!ingredients || ingredients.length === 0) && (
                  <li className="text-sm text-gray-500">لا توجد مكونات مدرجة.</li>
                )}
              </ul>
            </aside>
            ...
            <section className="md:w-2/3">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold mb-3">التعليمات</h2>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {s.time && <p className="mt-2 text-xs text-gray-500">التقدير: {s.time}</p>}
                      </div>
                    </div>
                  </li>
                ))}
                {(!recipe.steps || recipe.steps.length === 0) && (
                  <li className="text-sm text-gray-500">لا توجد تعليمات مقدمة.</li>
                )}
              </ol>
            </section>
          </div>
          ...
          {images.length > 0 && (
            <section className="mt-6">
              <h3 className="text-md font-semibold mb-3">المعرض</h3>
