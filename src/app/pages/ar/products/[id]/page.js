  ...
  if (!product) {
    return (
      <section dir="rtl" className={styles.wrapper}>
        <div className={styles.notFound}>المنتج غير موجود.</div>
      </section>
    );
  }

  const title = product.titleAr || product.title;
  const description = product.descriptionAr || product.description || title;

  return (
    <section dir="rtl" className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
