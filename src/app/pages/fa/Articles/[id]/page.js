...
// import { getArticleById } from '@/app/lib/cheeseData';
// // برای آیکون‌های زیبا، این پکیج را نصب کنید: npm install lucide-react
...
//   if (!article) {
//     return <div className="p-6 text-center">مقاله پیدا نشد</div>;
//   }
...
//   // تاریخ فرضی برای نمایش (اگر در دیتای شما هست جایگزین کنید)
//   const publishDate = article.createdAt 
//     ? new Date(article.createdAt).toLocaleDateString('fa-IR', { year: 'numeric', month: 'long', day: 'numeric' }) 
//     : "۲۷ بهمن ۱۴۰۴";
...
//         {/* === بخش هدر: عنوان، دسته‌بندی و اطلاعات متا === */}
//         <header className="mb-10 text-center md:text-right">
//           <div className="inline-flex items-center gap-2 mb-4 text-sm font-medium text-amber-600 dark:text-amber-500 bg-amber-50 dark:bg-amber-900/20 px-3 py-1 rounded-full">
//             <span>مقاله‌ها</span>
...
//           <div className="flex flex-wrap items-center justify-center md:justify-start gap-x-6 gap-y-2 text-slate-500 dark:text-slate-400 text-sm md:text-base border-b border-slate-200 dark:border-slate-800 pb-8">
...
//         {/* === تصویر شاخص مقاله === */}
//         {article.image && (
//           <figure className="relative w-full aspect-video mb-12 overflow-hidden rounded-2xl shadow-xl dark:shadow-none ring-1 ring-slate-900/5 dark:ring-white/10">
//             <img 
//               src={article.image} 
//               alt={title} 
...
//         {/* === خلاصه مقاله (لید) === */}
//         {summary && (
//           <div className="mb-12 p-6 md:p-8 bg-slate-50 dark:bg-slate-800/50 rounded-xl border-r-4 border-amber-500">
//             <p className="text-lg md:text-xl font-medium leading-relaxed text-slate-700 dark:text-slate-300 italic">
//               {summary}
//             </p>
//           </div>
//         )}

//         {/* === محتوای اصلی مقاله با استایل Typography === */}
//         <div 
//           className="
...
//             prose-blockquote:border-r-4 prose-blockquote:border-slate-300 dark:prose-blockquote:border-slate-700
