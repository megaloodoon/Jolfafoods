...
export default function Page() {
  return (
    <main dir="rtl" className="flex min-h-screen flex-col font-sans bg-white">
      ...
      {/* بخش چرا جلفا */}
      <div
        className="md:py-24 lg:py-56 px-6 text-center bg-cover bg-center bg-no-repeat w-full"
        style={{
          backgroundImage:
      ...
      >
        <h3 className="text-2xl md:text-4xl font-bold text-[#1a4b8c] mb-10 px-4">
          فوت و فن با رسپی های جلفا
        </h3>

        {/* استفاده از گرید ۳ ستونه برای قرارگیری همیشگی در یک خط */}
        <div className="grid grid-cols-3 gap-2 sm:gap-8 md:gap-24 px-4 justify-items-center">
          <div className="flex flex-col items-center gap-2 md:gap-4 text-[#1a4b8c]">
            <Image
              src="/Image/New/Icons/fast-icon.png"
              alt="سریع"
              width={160}
              height={80}
              className="w-[70px] sm:w-[100px] md:w-[160px] h-auto object-contain"
            />
            <span className="text-sm md:text-xl font-bold">سریع</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 md:gap-4 text-[#1a4b8c]">
            <Image
              ...
              className="w-[70px] sm:w-[100px] md:w-[160px] h-auto object-contain"
            />
            <span className="text-sm md:text-xl font-bold">لذیذ</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 md:gap-4 text-[#1a4b8c]">
            <Image
              ...
              className="w-[70px] sm:w-[100px] md:w-[160px] h-auto object-contain"
            />
            <span className="text-sm md:text-xl font-bold">متفاوت</span>
          </div>
        </div>
      </div>
