...
export default async function NewsPageFa() {
  ...
  return (
    <main dir="rtl" className="w-full">
      ...
      <section className="relative w-full h-[40vh] min-h-[300px]">
        <Image
          src="/Image/New/News/news-banner.png" // مسیر عکس بنر سالن کنفرانس را اینجا قرار دهید
          alt="خبرهای جلفا"
          fill
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <h1 className="text-white text-4xl md:text-5xl lg:text-6xl font-bold drop-shadow-lg text-center px-4">
            خبرهای جلفایی رو اینجا بخونید
          </h1>
        </div>
      </section>

      {/* لیست اخبار */}
      <NewsListClient newsList={newsList} locale="fa" />
    </main>
  );
}
