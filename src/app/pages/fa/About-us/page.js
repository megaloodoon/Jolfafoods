...
export default function AboutUsFa() {
  return (
    <main dir="rtl" className="w-full font-sans text-neutral-800 bg-white ">
      ...
      <ScrollReveal className="relative w-full h-[50vh] md:h-[70vh] flex items-center justify-center bg-cover bg-center bg-no-repeat bg-[url('/Image/About-Us/Factory.png')]">
      ...
      <section className="w-full py-16 xs:-mt-3 md:py-24 font-kalame text-white relative overflow-hidden bg-cover bg-center bg-no-repeat bg-[url('/Image/About-Us/About-us-background.png')]">
        <div className="max-w-6xl mx-auto px-6 md:px-10 flex flex-col gap-20">
          ...
          >
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base md:text-lg leading-2 text-blue-50 text-justify">
                ...
                را در این گروه به صورت منحصر به فرد عرضه کند.
              </p>
            </div>
            <div className="p-4">
              <img
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base md:text-lg leading-2 text-blue-50 text-justify">
                این شرکت با بهره گیری از انواع مواد اولیه ی تازه و انواع ماشین
                آلات پیشرفته ی صنعتی در تلاش است تا با کیفیت ترین و سالم ترین
                پنیرهای پیتزای به مصرف کنندگان داخلی و خارجی عرضه نماید. در همین
                راستا همواره و همگام با علم روز دنیا به طور مداوم فرمولاسیون
                ویژه تولید خود را ارتقاء می دهد.
              </p>
            </div>
          </ScrollReveal>
          ...
          >
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base md:text-lg leading-2 text-blue-50 text-justify">
                خط تولید پیشرفته و حساسیت ما نسبت به کیفیت باعث می شود هر محصول
                به ایده آل ترین حالت ممکن به دست مصرف کننده برسد. در همین راستا
                بخش‌های اختصاصی تضمین کیفیت (QA) و کنترل کیفیت (QC) ما اطمینان
                می‌دهند که هر محصولی که از خط تولید خارج می شود چندین بار آزمایش
                و بررسی شود تا کیفیت و یکنواختی تضمین گردد.{" "}
              </p>
            </div>
            <div className="p-4">
              <img
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="text-base md:text-lg leading-2 text-blue-50 text-justify">
                این شرکت علاوه بر توزیع سراسری در کشور به ویژه از طریق فروشگاه
                های زنجیره ای بزرگ، همچنین موفق شده است محصولات خود را به
                کشورهای همسایه، حوزه ی خلیج فارس، اوراسیا و همچنین آمریکای جنوبی
                صادر کند. از ترکیبات اختصاصی مطابق سلیقه های محلی تا محصولات
                ویژه بازارهای جهانی، ما در کنار مشتریان عزیز خود هستیم.{" "}
              </p>
            </div>
          </ScrollReveal>
        </div>
      ...
      <ScrollReveal
        delay={100}
        className="relative z-10 flex flex-col w-full bg-[#fbe1ac] -mt-4 xs:-mt-1 sm:-mt-4 md:-mt-1 lg:-mt-2 xxlg:-mt-4 xxxlg:-mt-4 mb-10 sm:mb-16 px-4 sm:px-6 md:px-8 py-10 xs:py-2 sm:py-2.5 md:py-3 lg:py-4 text-center"
      >
        {/* لبه تزئینی بالا */}
      ...
      <ScrollReveal
        delay={200}
        className="w-full md:bg-transparent -mt-10 pb-10 md:pb-0"
      >
        <img
