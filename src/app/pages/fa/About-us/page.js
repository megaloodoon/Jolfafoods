export default function AboutUsFa() {
  return (
    <main dir="rtl" className="w-full font-sans text-neutral-800 bg-white">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-4">
                ...
                />
                <h2 className="text-2xl md:text-3xl font-bold">پیشینه ی ما</h2>
              </div>
      ...
      <section
        className="w-full py-26 px-6 lg:py-40 md:px-10 text-center bg-cover bg-center bg-no-repeat"
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-base md:text-xl leading-8 md:leading-9 text-[#1a4b8c] font-medium text-justify md:text-center">
            ...
            غذایی کشور شده است. این شرکت در سال ۱۴۰۳ موفق به کسب گواهینامه
            اهتمام به کیفیت از سمت سازمان ملی استاندارد ایران گردید و هم‌زمان
            عنوان واحد تولیدکننده برتر صنایع غذایی استان اصفهان را نیز به دست
            آورد. همچنین کسب مقام مسئول فنی برتر صنایع غذایی استان اصفهان، که
            نشان‌دهنده‌ی توانمندی و شایستگی مدیریت فنی مجموعه است، از دیگر
            افتخارات این شرکت می باشد. در ادامه‌ی مسیر نوآوری، شرکت عصر طلایی
            برتر اسپادانا در سال ۱۴۰۴ با ثبت اختراع سس پنیر پروسس، جایگاه خود را
            در توسعه محصولات دانش‌بنیان صنعت غذا تثبیت نمود.
          </p>
        </div>
      </section>
