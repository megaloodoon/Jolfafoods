...
export default function Page() {
  const labels = {
    ...
    successMessage:
      "Спасибо за обращение. Наша команда рассмотрит ваше сообщение в ближайшее время.",
    ...
    formSocialLabel: "ID в соцсетях",
    formSocialPlaceholder: "Введите ваш ID...",
    formCountryLabel: "Страна",
    formCountryPlaceholder: "напр., Иран",
    formCityLabel: "Город",
    formCityPlaceholder: "напр., Исфахан",
  };
  ...
  return (
    <main dir="ltr" className="min-h-screen">
      <ContactPage
        ...
        description={
          "По вопросам продаж, сотрудничества или общим вопросам свяжитесь с нашим заводом или напишите в Telegram/Instagram. Мы отвечаем в рабочие часы. Укажите детали запроса для более быстрого ответа."
        }
        labels={labels}
      />
    </main>
