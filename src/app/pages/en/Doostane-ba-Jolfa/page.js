...
export default function DoostaneBaJolfaPageEN() {
  return (
    <main dir="ltr" className="w-full bg-[rgb(216,230,254)] pb-0 font-sans">
      ...
      <section className="relative w-full overflow-hidden flex items-end justify-center bg-white">
        ...
        <div className="relative z-20 w-full h-full flex justify-center items-center">
          <img
            ...
            alt="Friendly with Jolfa Banner"
      ...
      <section className="relative w-full bg-gradient-to-b from-white via-white/60 to-[rgb(216,230,254)] overflow-hidden z-40 -mt-16 md:-mt-24 py-16 md:py-24 pb-24 md:pb-32">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16 lg:gap-24">
            <Link href="/pages/en/Doostane-ba-Jolfa/recipes" className="flex flex-col items-center group">
              <img src="/Image/New/Icons/Recipes.png" alt="Recipes Icon" className="w-36 h-36 md:w-44 md:h-44 object-contain transition-transform duration-300 group-hover:scale-105 drop-shadow-md" />
              <h2 className="mt-4 text-2xl md:text-3xl font-bold text-[#1a4b8c]">Recipes</h2>
            </Link>

            <Link href="/pages/en/Doostane-ba-Jolfa/News" className="flex flex-col items-center group">
              <img src="/Image/New/Icons/News.png" alt="News Icon" className="w-36 h-36 md:w-44 md:h-44 object-contain transition-transform duration-300 group-hover:scale-105 drop-shadow-md" />
              <h2 className="mt-4 text-2xl md:text-3xl font-bold text-[#1a4b8c]">News</h2>
            </Link>

            <Link href="/pages/en/Doostane-ba-Jolfa/Articles" className="flex flex-col items-center group">
              <img src="/Image/New/Icons/Articles.png" alt="Articles Icon" className="w-36 h-36 md:w-44 md:h-44 object-contain transition-transform duration-300 group-hover:scale-105 drop-shadow-md" />
