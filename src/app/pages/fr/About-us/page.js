    ...
    <main dir="ltr" className="w-full font-sans text-neutral-800 bg-white">
      ...
      <ScrollReveal delay={100} className="relative z-10 flex flex-col w-full bg-[#fbe1ac] -mt-4 xs:-mt-1 sm:-mt-4 md:-mt-1 lg:-mt-2 xxlg:-mt-4 xxxlg:-mt-4 mb-10 sm:mb-16 px-4 sm:px-6 md:px-8 py-10 xs:py-2 sm:py-2.5 md:py-3 lg:py-4 text-center">
        ...
        <p className="max-w-4xl mx-auto text-[#1a4b8c] font-bold text-sm sm:text-base md:text-lg leading-relaxed sm:leading-loose drop-shadow-sm">
          La société Asre Talaei Bartar Spadana, propriétaire des marques Jolfa et Mazesta, s'appuyant sur la qualité, l'innovation et l'expertise, a remporté de précieux honneurs dans l'industrie alimentaire. En 2024, l'entreprise a obtenu le certificat d'engagement envers la qualité de l'Organisation Nationale Iranienne de Normalisation et a simultanément remporté le titre de meilleure unité de production de l'industrie alimentaire de la province d'Ispahan. De plus, l'obtention du titre de meilleur responsable technique de l'industrie alimentaire de la province d'Ispahan, qui démontre la capacité et la compétence de la direction technique de l'entreprise, figure parmi ses autres réalisations. Poursuivant sur la voie de l'innovation, l'entreprise a consolidé en 2025 sa position dans le développement de produits alimentaires basés sur la connaissance en brevetant la sauce au fromage fondu.
        </p>
