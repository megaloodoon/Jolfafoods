...
export default function ProductsPage() {
  ...
  const getTitle = (product) => product.titleFr || product.titleEn || product.title;

  // Divide products into pages with 6 products per page
              ...
              <SwiperSlide key={pageIndex}>
                <div className={styles.grid}>
                  {pageProducts.map((product) => (
                    <Link
                      key={product.id}
                      href={`/pages/fr/products/${product.id}`}
