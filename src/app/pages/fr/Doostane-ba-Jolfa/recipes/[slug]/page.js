        ...
        <div className="p-6 md:p-8">
            ...
            <aside className="md:w-1/3">
              ...
              <ul className="space-y-2">
                ...
                {(!ingredients || ingredients.length === 0) && (
                  <li className="text-sm text-gray-500">Aucun ingrédient listé.</li>
                )}
              </ul>
            </aside>
                  ...
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        {s.time && <p className="mt-2 text-xs text-gray-500">Estimé: {s.time}</p>}
                      </div>
                    </div>
                  </li>
                ))}
                {(!recipe.steps || recipe.steps.length === 0) && (
                  <li className="text-sm text-gray-500">Aucune instruction fournie.</li>
                )}
              </ol>
            </section>
          </div>
          ...
          {images.length > 0 && (
            <section className="mt-6">
              <h3 className="text-md font-semibold mb-3">Galerie</h3>
          ...
          {recipe.notes && (
            <section className="mt-6">
              <h3 className="text-md font-semibold mb-2">Remarques</h3>
