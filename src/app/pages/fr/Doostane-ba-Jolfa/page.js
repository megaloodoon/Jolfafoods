      ...
      <section className="relative w-full overflow-hidden">
        ...
        <div className="relative z-20 w-full h-full flex justify-center px-4">
          <img
            ...
            alt="Bannière Amical avec Jolfa"
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 md:-mt-24 relative z-40 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16 lg:gap-24">
          <Link href="/pages/fr/Doostane-ba-Jolfa/recipes" className="flex flex-col items-center group">
            <img src="/Image/New/Icons/Recipes.png" alt="Icône Recettes" className="w-36 h-36 md:w-44 md:h-44 object-contain transition-transform duration-300 group-hover:scale-105" />
          ...
          <Link href="/pages/fr/Doostane-ba-Jolfa/News" className="flex flex-col items-center group">
            <img src="/Image/New/Icons/News.png" alt="Icône Actualités" className="w-36 h-36 md:w-44 md:h-44 object-contain transition-transform duration-300 group-hover:scale-105" />
          ...
          <Link href="/pages/fr/Doostane-ba-Jolfa/Articles" className="flex flex-col items-center group">
            <img src="/Image/New/Icons/Articles.png" alt="Icône Articles" className="w-36 h-36 md:w-44 md:h-44 object-contain transition-transform duration-300 group-hover:scale-105" />
