...
export default async function SingleNewsPage({ params }) {
  ...
  const locale = "fr"; // برای فرانسه "fr"، عربی "ar" و روسی "ru" قرار دهید
        ...
        <div className="bg-white rounded-[2rem] shadow-[0_15px_60px_-15px_rgba(30,58,138,0.15)] overflow-hidden">
          ...
          <div className="relative p-8 md:p-12 lg:p-16">
            ...
            <div className="relative z-10">
              ...
              {/* بخش دکمه بازگشت */}
              <div className={`mt-16 pt-8 border-t border-gray-100 flex ${isRtl ? "md:justify-end" : "md:justify-start"} justify-center`}>
                <Link
