...
export default function Footer() {
  ...
  return (
    <footer className="text-white bg-[#154994] py-1 md:py-2 relative mt-[15px]">
      {/* لبه تزئینی SVG */}
      ...
      <div
        className="w-full max-w-7xl mx-auto px-2 sm:px-2 md:px-4 flex flex-row flex-nowrap justify-between items-center relative z-20 pb-2 md:pb-0"
        dir={isRtl ? "rtl" : "ltr"}
      >
        {isRtl ? (
          <>
