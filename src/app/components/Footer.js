...
import ScrollReveal from "./ScrollReveal"; // مسیر ایمپورت را با پروژه خود بررسی کنید
...
export default function Footer() {
  ...
  // استفاده از متغیر به جای تعریف کامپوننت داخلی برای جلوگیری از Re-mount در هر رندر
  const logoColumn = (
    <div
